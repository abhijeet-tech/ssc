...
/* Experiment with setting the dataSource property using either setter or field injection.
...
public class JdbcRestaurantRepository implements RestaurantRepository {
	...
	/* Mark this method with an annotation that will cause it to be executed by
	...
	/* Add a breakpoint inside clearRestaurantCache(). Re-run RewardNetworkTests in debug mode.
